...
public class esercizio4 {
    ...
    private static void exercise1() {
        ...
        try {
            Files.writeString(Path.of(MY_PATH.toUri()), y.toString());
            // Your code here
    ...
    private static void exercise2() {
        ...
        try {
            ...
            System.out.println(Files.readString(Path.of(MY_PATH.toUri())));
            // Your code here
        } catch (Exception exception) {
            System.err.println("There was an error!");
            exception.printStackTrace();
    ...
    private static void exercise3() {
        ...
        try {
            System.out.println(Arrays.stream(Files.readString(Path.of("file.txt")).split("\n")).count());
            // Your code here
        } catch (Exception exception) {
            System.err.println("There was an error!");
            exception.printStackTrace();
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4: ");
        try {
            System.out.println(Arrays.stream(Files.readString(Path.of(MY_PATH.toUri())).split(" ")).count());
            Files.delete(Path.of(MY_PATH.toUri()));
            // Your code here
        } catch (Exception exception) {
            System.err.println("There was an error!");
            exception.printStackTrace();
