public class introduzione_esercizio6 {
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives ="2"+"3.5"+'p'+true+3; // <--- Edit this line
        System.out.println(textFrom2Primitives);
    }
//tutto quello che viene inserito nella variabile si comporta come stringa (in quanto abbiamo dichiarato che la variabile sarà, appunto, una stringa)
//di conseguenza, tutti i valori verranno stampati senza sommare nulla tra di loro nonostante il segno +
